...
import { Setting, Site } from '@src/types';
...
const utilContext = {
  ...
  insertSite: async (site: Site) => ipcRenderer.invoke('repository:site:insert', site),
  updateSite: async (site: Site) => ipcRenderer.invoke('repository:site:update', site),
