...
export const allowedDefaultShortcuts: Shortcut[] = [
  ...
  { label: '', shift: true, key: 'pageup' },
  { label: '', shift: true, key: 'pagedown' },
  { label: '', shift: true, key: 'home' },
  { label: '', shift: true, key: 'end' },
  { label: '', ctrl: true, shift: true, key: 'pageup' },
  { label: '', ctrl: true, shift: true, key: 'pagedown' },
  { label: '', ctrl: true, shift: true, key: 'home' },
  { label: '', ctrl: true, shift: true, key: 'end' },
